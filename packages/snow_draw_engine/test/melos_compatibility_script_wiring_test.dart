...
void main() {
  test('melos compatibility script runs required contract tests in order', () {
    ...
    const orderedCommands = <String>[
      ...
      'dart test packages/snow_draw_engine/test/melos_compatibility_script_wiring_test.dart',
      'dart test packages/snow_draw_engine/test/engine_entrypoint_contract_test.dart',
      'dart test packages/snow_draw_engine/test/element_serialization_compatibility_test.dart',
      'dart test packages/snow_draw_engine/test/element_default_json_compatibility_test.dart',
      'dart test packages/snow_draw_engine/test/element_type_id_compatibility_test.dart',
      'dart test packages/snow_draw_engine/test/element_registry_characterization_test.dart',
      'dart test packages/snow_draw_engine/test/built_in_render_task_support_test.dart',
      'dart test packages/snow_draw_engine/test/draw_config_defaults_compatibility_test.dart',
      'dart test packages/snow_draw_engine/test/action_payload_immutability_test.dart',
      'dart test packages/snow_draw_engine/test/action_type_name_compatibility_test.dart',
      'dart test packages/snow_draw_engine/test/types/draw_color_test.dart',
      'dart test packages/snow_draw_engine/test/text_metrics_service_compatibility_test.dart',
      'dart test packages/snow_draw_engine/test/draw_context_text_metrics_compatibility_test.dart',
