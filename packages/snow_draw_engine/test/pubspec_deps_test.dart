// Tests that verify pubspec dependency hygiene for snow_draw_engine.
...
import 'package:snow_draw_engine/draw/utils/lru_cache.dart';
import 'package:test/test.dart';

void main() {
  group('snow_draw_engine dependency smoke tests', () {
