...
const _allowedExports = <String>{
  ...
  'draw/core/coordinates/element_space.dart',
  'draw/edit/arrow/arrow_point_operation.dart',
  'draw/edit/core/edit_operation_params.dart',
  'draw/edit/free_transform/free_transform_context.dart',
  'draw/elements/core/element_data.dart',
  'draw/elements/core/element_definition.dart',
  'draw/elements/core/element_hit_tester.dart',
  ...
  'draw/elements/types/free_draw/free_draw_creation_strategy.dart',
  'draw/elements/types/free_draw/free_draw_data.dart',
  'draw/elements/types/free_draw/free_draw_hit_tester.dart',
  ...
  'draw/input/input_event.dart',
  'draw/input/plugin_system.dart',
  ...
  'draw/types/edit_operation_id.dart',
  'draw/types/edit_transform.dart',
  'draw/types/element_style.dart',
  'draw/types/draw_point.dart',
  'draw/types/draw_rect.dart',
  'draw/types/resize_mode.dart',
