...
void main() {
  testWidgets('main toolbar shows watermark tool button', (tester) async {
    ...
    expect(find.byTooltip('Watermark'), findsOneWidget);

    await tester.tap(find.byTooltip('Watermark'));
    await tester.pumpAndSettle();

    expect(controller.value, ToolType.watermark);
  });
}
