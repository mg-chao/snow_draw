...
/// rects expanded by stroke-aware padding so the dynamic scene includes only
/// nearby top-order occluders.
List<DrawRect> resolveOptimizedOccluderQueryRects({
  ...
  final padding = math.max(
    linePaddingFloor,
    strokeWidth * linePaddingStrokeFactor,
  );
